...
TRIPS = [
    ...
    },
    {
        ...
        'sections': [
            ...
            {'type': 'story', 'en': 'Then over to Phuket, the big-island version of all this: driving everywhere, good cafes, long beaches, and even a water park.',
             'he': 'ואז לפוקט, הגרסה של האי הגדול לכל זה: נסיעות לכל מקום, בתי קפה טובים, חופים ארוכים, ואפילו פארק מים.'},
            ...
            {'type': 'photo', 'src': 'thailand-phuket-cafe.jpg', 'w': 720, 'h': 1280,
             'alt_en': 'A croissant with salad and a latte with leaf art at a Phuket cafe', 'alt_he': 'קרואסון עם סלט ולאטה עם ציור עלה בבית קפה בפוקט',
             'cap_en': 'A cafe breakfast in Phuket.', 'cap_he': 'ארוחת בוקר בבית קפה בפוקט.'},
            ...
            {'type': 'story', 'en': 'A day out into Phang Nga Bay: a speedboat through the limestone karsts, kayaking under the cliffs, a roadside fruit stop, and the longtails of Koh Phi Phi.',
             'he': 'יום בשייט אל מפרץ פאנג נגה: סירת מהירות בין צוקי הגיר, קייאקים מתחת למצוקים, עצירת פירות בצד הדרך, וסירות הלונגטייל של קו פי פי.'},
