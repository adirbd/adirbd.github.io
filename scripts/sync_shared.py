...
TRIPS = [
    ...
    },
    {
        ...
        'sections': [
            ...
            {'type': 'story', 'en': 'Then south to the islands. A short flight into Koh Samui\'s little garden airport, then on to Ko Tao, Phuket, and Koh Phi Phi: blue water, limestone cliffs, and long days on and around the sea.',
             'he': 'ואז דרומה לאיים. טיסה קצרה לשדה התעופה הקטן והירוק של קו סמוי, ומשם לקו טאו, פוקט וקו פי פי: מים כחולים, צוקי גיר, וימים ארוכים על הים ולצדו.'},
