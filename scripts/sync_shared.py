...
TRIPS = [
    ...
    },
    {
        ...
        'sections': [
            ...
            {'type': 'photo', 'src': 'thailand-phiphi-portrait.jpg', 'w': 1024, 'h': 1280,
             'alt_en': 'Adir in a floral shirt on a longtail boat with cliffs and orchids behind at Koh Phi Phi', 'alt_he': 'אדיר בחולצה פרחונית על סירת לונגטייל עם מצוקים וסחלבים מאחור בקו פי פי',
             'cap_en': 'On the boat around Phi Phi.', 'cap_he': 'על הסירה סביב פי פי.'},
