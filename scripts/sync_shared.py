...
TRIPS = [
    ...
    },
    {
        ...
        'sections': [
            ...
            {'type': 'photo', 'src': 'thailand-kohtao-dinner.jpg', 'w': 720, 'h': 1280,
            ...
            {'type': 'story', 'en': 'Then on to Phuket and Koh Phi Phi: limestone cliffs, longtail boats, and jet skis on the blue.',
             'he': 'ואז לפוקט ולקו פי פי: צוקי גיר, סירות לונגטייל, ואופנועי ים על הכחול.'},
