...
TRIPS = [
    ...
    },
    {
        ...
        'sections': [
            ...
            {'type': 'story', 'en': 'Ko Tao had a boat day in it too: out by longtail to snorkel among the granite boulders and pull up on quiet beaches, then sunset drinks at a hilltop bar and dinner with friends.',
             'he': 'בקו טאו היה גם יום סירה: יציאה בלונגטייל לשנורקל בין סלעי הגרניט ועצירה בחופים שקטים, ואז דרינקים בשקיעה בבר על הגבעה וארוחת ערב עם חברים.'},
            ...
            {'type': 'story', 'en': 'Back on Ko Samui, the day was all jet skis: a tour out across a calm green bay, opening it up on the open water, and dinner with friends to finish.',
             'he': 'בחזרה בקו סמוי, היום היה כולו אופנועי ים: סיור על פני מפרץ ירוק ורגוע, פתיחת גז על המים הפתוחים, וארוחת ערב עם חברים לסיום.'},
            ...
            {'type': 'photo', 'src': 'thailand-samui-dinner.jpg', 'w': 720, 'h': 1280,
             'alt_en': 'Adir and two friends smiling over fresh coconuts at a restaurant table at night', 'alt_he': 'אדיר ושני חברים מחייכים מעל קוקוסים טריים בשולחן מסעדה בלילה',
             'cap_en': 'Dinner and fresh coconuts with friends.', 'cap_he': 'ארוחת ערב וקוקוסים טריים עם חברים.'},
            {'type': 'story', 'en': 'Then on to Phuket and Koh Phi Phi: limestone cliffs and longtail boats on the blue.',
             'he': 'ואז לפוקט ולקו פי פי: צוקי גיר וסירות לונגטייל על הכחול.'},
