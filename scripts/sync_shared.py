...
TRIPS = [
    {
        ...
        'sections': [
            {'type': 'story', 'en': 'After Osaka and Nara, Kyoto slowed things down — the bamboo paths of Arashiyama, a good bowl of ramen, and a detour to the Nintendo Museum just outside the city.',
             'he': 'אחרי אוסקה ונארה, קיוטו האטה את הקצב — שבילי הבמבוק של ארשיאמה, קערת ראמן טובה, וקפיצה למוזיאון נינטנדו ממש מחוץ לעיר.'},
            ...
            {'type': 'photo', 'src': 'japan-bamboo-path.jpg', 'w': 768, 'h': 1024,
             'alt_en': 'The bamboo grove path at Arashiyama', 'alt_he': 'שביל יער הבמבוק בארשיאמה',
    ...
    },
    {
        ...
        'teaser_he': 'טיול סנובורד באבוריאז שבאלפים הצרפתיים — רכבלים, מסלולים ארוכים, ואור הרים מהמעלית הראשונה עד האחרונה.',
    ...
    },
    {
        ...
        'sections': [
            ...
            {'type': 'story', 'en': 'Then south to the islands — Ko Tao, Phuket, and Koh Phi Phi: blue water, limestone cliffs, and long days on and around the sea.',
             'he': 'ואז דרומה לאיים — קוֹ טאו, פוקט וקו פי פי: מים כחולים, צוקי גיר, וימים ארוכים על הים ולצדו.'},
